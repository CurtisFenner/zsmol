...
pub const CNF = struct {
    ...
    pub fn satisfiable(self: *CNF) !?[]const bool {
        ...
        while (true) {
            // TODO: Invariant:
            // & there are no contradicted clauses;
            // & there are no unit clauses
            // & every unsatisfied clause has at least 2 undetermined literals
            // & at least two unsatisfied literals of every unsatisfied clause is watched
